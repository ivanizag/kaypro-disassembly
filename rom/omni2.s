...
; NOTES:
;
;   It's the 81-232 ROM with a few differences:
; - "OMNI II" instead of "KAYPRO" on the welcome message.
; - The cursor does not blink
; - The characters used for latin and greek are extended.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
; On this ROM
console_alphabet_ascii_mask:    EQU 0xff
console_alphabet_greek_mask:    EQU 0x9f
...
translate_keyboard_in_a:
    ...
    OR A
    SBC HL,DE
    LD DE,translate_keyboard_values-1
    ADD HL,DE
    LD A,(HL)
    RET
translate_keyboard_size: EQU 0x13
translate_keyboard_keys:
    DB 0xF1, 0xF2, 0xF3, 0xF4 ; Arrow keys
    DB 0xB1, 0xC0, 0xC1, 0xC2 ; Numerical keypad
    DB 0xD0, 0xD1, 0xD2, 0xE1
    DB 0xE2, 0xE3, 0xE4, 0xD3
    DB 0xC3, 0xB2
    DB 0xFF
translate_keyboard_values:
    DB 0x80, 0x81, 0x82, 0x83 ; Arrow keys
    DB 0x84, 0x85, 0x86, 0x87 ; Numerical keypad
    DB 0x88, 0x89, 0x8A, 0x8B
